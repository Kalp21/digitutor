<%@ Page Title="" Language="C#" MasterPageFile="~/admin_pages/admin.master" AutoEventWireup="true" CodeFile="add_locations.aspx.cs" Inherits="admin_pages_add_locations" %>
...
<!--main content start-->
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-files-o"></i>ADD LOCATION</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="dashboard.aspx">Home</a></li>
						<li><i class="icon_document_alt"></i>Location</li>
						<li><i class="fa fa-files-o"></i>Add Location</li>
					</ol>
				</div>
			</div>
              <!-- Form validations -->              
                              ...
                              <div class="form">
                                  <div class="form-validate form-horizontal" id="feedback_form">
                                      ...
                                      <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">Location Name <span class="required"></span></label>
                                          <div class="col-lg-10">
    ...
    TargetControlID="txt_name" />
                                       ...
                                       <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">Location Pincode<span class="required"></span></label>
                                          <div class="col-lg-10">
                                              <asp:TextBox runat ="server" cssclass="form-control"  ID="txt_pincode" MaxLength="6" />
                                              <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender3" runat="server" FilterType="Numbers" TargetControlID="txt_pincode" />
                                          </div>
                                      </div>
