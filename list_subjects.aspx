<%@ Page Title="" Language="C#" MasterPageFile="~/admin_pages/admin.master" AutoEventWireup="true" CodeFile="list_subjects.aspx.cs" Inherits="admin_pages_list_subjects" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
 ...
 <!--main content start-->
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-files-o"></i>LIST SUBJECTS</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="dashboard.aspx">Home</a></li>
						<li><i class="icon_document_alt"></i>Subjects</li>
						<li><i class="fa fa-files-o"></i>List Subjects</li>
					</ol>
				</div>
			</div>
              <!-- Form validations -->              
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          <header class="panel-heading">
                              ALL SUBJECTS IN THE CURRENT SYSTEM
                          </header>
                          <div class="panel-body">
                                                        <div class="form">
                                                                <asp:Label ID="lbl_error" runat ="server" Text ="THERE ARE NO SUBJECTS PRESENT IN THE SYSTEM" Visible ="false" ></asp:Label>
    <!--  search form start -->
                       ...
                       <div class="btn-group" >
                            ...
                            <asp:Button  class="btn-info" id="btn_search" runat ="server" Text ="Search" 
                                ...
                                onselectedindexchanged="ddl_reduce_SelectedIndexChanged1">
                                    <asp:ListItem Text ="Show Active" Value ="select_active_subjects" ></asp:ListItem> 
                            <asp:ListItem Text ="Show Inactive" Value="select_inactive_subjects"></asp:ListItem>
                            </asp:DropDownList>
                            <br />
                            <br />
                          </div>   
    ...
    <asp:GridView ID="grd_list_tutors" runat="server" AutoGenerateColumns="False" OnRowEditing="row_editing"
        OnRowDeleting="row_deleting" DataKeyNames="sub_id" 
        ...
        <Columns>
            <asp:TemplateField HeaderText="Id">
                <ItemTemplate>
                    <asp:Label ID="lbl_id" runat="server" Text='<%# Eval("sub_id") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
           
            <asp:TemplateField HeaderText="Name">
                <ItemTemplate>
                    <asp:Label ID="lbl_name" runat="server" Text='<%# Eval("sub_name") %>'></asp:Label>
                </ItemTemplate>
                <EditItemTemplate>
                    <asp:TextBox ID="txt_name" runat="server" Text='<%# Eval("sub_name")%>'></asp:TextBox>
                </EditItemTemplate>
            </asp:TemplateField>
           
            <asp:TemplateField HeaderText="Subject Status">
                <ItemTemplate>
                    <asp:Label ID="lbl_status" runat="server" Text='<%# Eval("sub_status") %>'></asp:Label>
                </ItemTemplate>
               <EditItemTemplate>
            ...
            <asp:TemplateField HeaderText="Tutors Of This Subject">
                <ItemTemplate>
            ...
            </asp:TemplateField><asp:TemplateField HeaderText="Students Of This Subject">
                <ItemTemplate>
                    <asp:Label ID="lbl_stu" runat="server" ></asp:Label>
                </ItemTemplate>
               <%-- <EditItemTemplate>
                    <asp:TextBox ID="txt_stu" runat="server"></asp:TextBox>
                </EditItemTemplate>--%>
            </asp:TemplateField>
