<%@ Page Title="" Language="C#" MasterPageFile="~/admin_pages/admin.master" AutoEventWireup="true" CodeFile="tutor_profile.aspx.cs" Inherits="admin_pages_tutor_profile" %>
...
<!--main content start-->
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-files-o"></i>TUTOR PROFILE</h3>
					<ol class="breadcrumb">
        ...
        Width="200px" style="margin:10px 50px 10px 500px" />
                                      ...
                                      <div class="form-group ">
                                          <label for="ccomment" class="control-label col-lg-2">Subjects Taught</label>
                                          <div class="col-lg-10">
                                      ...
                                      <div class="form-group ">
                                          <label for="ccomment" class="control-label col-lg-2">Locations Covered</label>
                                          <div class="col-lg-10">
                                      ...
                                      <div class="form-group ">
                                          <label for="ccomment" class="control-label col-lg-2">Package Bought</label>
                                          <div class="col-lg-10">
                                      ...
                                      <div class="form-group ">
                                          <label for="ccomment" class="control-label col-lg-2">Boards Covered</label>
                                          <div class="col-lg-10">
                                      ...
                                      <div class="form-group ">
                                          <label for="ccomment" class="control-label col-lg-2">Classes Covered</label>
                                          <div class="col-lg-10">
                                      ...
                                      <div class="form-group">
                                          ...
                                          <asp:Button runat="server"  ID="Button2" CssClass ="btn btn-primary " Text ="Ok" 
                                              PostBackUrl="~/admin_pages/list_tutors.aspx" onclick="Button2_Click1" />
                                          </div>
                                      </div>
                                  </div>
                              </div>
